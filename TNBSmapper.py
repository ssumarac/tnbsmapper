...
mrn = st.sidebar.number_input("MRN")
...
target = st.sidebar.sidebar.selectbox('Select Target', ['STN', 'GPi', 'VIM'])
s_track = st.sidebar.sidebar.selectbox("Track:",["s1","s2","s3","s4","s5","s6","s7","s8","s9","s10"])
hemi = st.sidebar.sidebar.selectbox("Hemisphere:",["Right", "Left"])
