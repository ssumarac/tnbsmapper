...
for i in range(51):
    ...
    if invert == "Inverted":
        ...
        if i == 35:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(10), fontsize=6)
        elif i == 34:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(9), fontsize=6)
        elif i == 33:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(8), fontsize=6)
        elif i == 32:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(7), fontsize=6)
        elif i == 31:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(6), fontsize=6)
        elif i == 30:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(5), fontsize=6)
        elif i == 29:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(4), fontsize=6)
        elif i == 28:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(3), fontsize=6)
        elif i == 27:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(2), fontsize=6)
        elif i == 26:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(1), fontsize=6)
        elif i == 25:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(0), fontsize=6)
        elif i == 24:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(-1), fontsize=6)
        elif i == 23:
            ax.text(trajectory_end_Y+i*trajetory_tick_Y+5,trajectory_end_Z+i*trajetory_tick_Z-2,str(-2), fontsize=6)
...
d10 = col11.text_input("10.0mm:")
d9_5 = col11.text_input("9.5mm:")
d9 = col11.text_input("9.0mm:")
d8_5 = col11.text_input("8.5mm:")
d8 = col11.text_input("8.0mm:")
d7_5 = col11.text_input("7.5mm:")
d7 = col11.text_input("7.0mm:")
d6_5 = col11.text_input("6.5mm:")
d6 = col11.text_input("6.0mm:")
d5_5 = col11.text_input("5.5mm:")
d5 = col11.text_input("5.0mm:")
d4_5 = col11.text_input("4.5mm:")
d4 = col11.text_input("4.0mm:")
d3_5 = col11.text_input("3.5mm:")
d3 = col11.text_input("3.0mm:")
d2_5 = col11.text_input("2.5mm:")
d2 = col11.text_input("2.0mm:")
d1_5 = col11.text_input("1.5mm:")
d1 = col11.text_input("1.0mm:")
d0_5 = col11.text_input("0.5mm:")
d0 = col22.text_input("0.0mm:")
dm0_5 = col22.text_input("-0.5mm:")
dm1 = col22.text_input("-1.0mm:")
dm1_5 = col22.text_input("-1.5mm:")
dm2 = col22.text_input("-2.0mm:")
dm2_5 = col22.text_input("-2.5mm:")
dm3 = col22.text_input("-3.0mm:")
dm3_5 = col22.text_input("-3.5mm:")
dm4 = col22.text_input("-4.0mm:")
dm4_5 = col22.text_input("-4.5mm:")
dm5 = col22.text_input("-5.0mm:")
dm5_5 = col22.text_input("-5.5mm:")
dm6 = col22.text_input("-6.0mm:")
dm6_5 = col22.text_input("-6.5mm:")
dm7 = col22.text_input("-7.0mm:")
dm7_5 = col22.text_input("-7.5mm:")
dm8 = col22.text_input("-8.0mm:")
